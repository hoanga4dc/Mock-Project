...
public:
	...
	void DisplayConvertPlayer(string s) {
		string temp[5];
		int d = 0;
		...
		stringstream s2n(temp[4]);
		double x;
		s2n >> x;
		cout << "Thong tin tai khoan: \n";
		cout << "Ten: " <<temp[0]<< endl;
		cout << "So tran thang: " << temp[1] << endl;
		cout << "So tran thua: " << temp[2] << endl;
		cout << "So tran hoa: " << temp[3] << endl;
		cout << "Ty le thang: " << x*100 <<"%"<< endl;
		cout << "--------------------\n";
	}
	void ProcessStep(string s,int a[10][10]) {
		int x, y;
		char p = s[0];
		string temp;
